...
class MultipleChoiceQuestion(Question):
    ...
    === Private Attributes ===
    _answers: a list of possible answers
    ...
    def __str__(self) -> str:
        ...
        """
        return self.text + ": " + str(self._answers)
    ...
    def validate_answer(self, answer: Answer) -> bool:
        ...
        question.
        """
        if answer.content in self._answers:
            return True
        else:
            return False
...
class NumericQuestion(Question):
    ...
    === Private Attributes ===
    _min: The minimum value of the range of possible correct answers, inclusive.
    _max: The maximum value of the range of possible correct answers, inclusive.
    ...
    def __str__(self) -> str:
        ...
        'question: min_ to max_'
        min_ and max_ are integers
        """
        return self.text + ": " + str(self._min) + " to " + str(self._max)
    ...
    def get_similarity(self, answer1: Answer, answer2: Answer) -> float:
        ...
        """if answer1 == answer2:
            return 1.0
        elif (answer1 == self._min and answer2 == self._max) or \
                (answer1 == self._max and answer2 == self._min):
            return 0.0
        else:
            return 1.0 - abs(answer1.content - answer2.content) / \
                   (self._max - self._min)"""
        abs_diff = abs(answer1.content - answer2.content)
        average = abs_diff/(self._max - self._min)
        return 1.0 - average
...
class CheckboxQuestion(MultipleChoiceQuestion):
    ...
    def validate_answer(self, answer: Answer) -> bool:
        ...
        if isinstance(answer.content, list) and len(answer.content) != 0:
            unique_answers = list(set(answer.content))
            unique_answers.sort()
            answer.content.sort()
        else:
            return False
        if unique_answers == answer.content:
            for ans in answer.content:
                if ans not in self._answers:
                    return False
            return True
        return False
    ...
    def get_similarity(self, answer1: Answer, answer2: Answer) -> float:
        ...
        <answer1> and <answer2> are both valid answers to this question
        """
        common = len(list(set(answer1.content).intersection(answer2.content)))
        unique = len(list(set(answer1.content).union(answer2.content)))
...
class Survey:
    ...
    def __init__(self, questions: List[Question]) -> None:
        ...
        This new survey should  a HomogeneousCriterion as a default criterion
    ...
    def __str__(self) -> str:
        ...
        list_of_questions = []
        for id_ in self._questions:
            list_of_questions.append(str(self._questions[id_]))
    ...
    def get_questions(self) -> List[Question]:
        ...
        list_of_questions = []
        for id_ in self._questions:
            list_of_questions.append(self._questions[id_])
    ...
    def score_students(self, students: List[Student]) -> float:
        ...
        try:
            sum_of_score = 0.0
            amount_of_scores = 0
            list_of_questions = self.get_questions()
            for question in list_of_questions:
                list_of_answers = []
                for student in students:
                    list_of_answers.append(student.get_answer(question))
                criterion = self._get_criterion(question)
                weight = self._get_weight(question)
                sum_of_score += weight * \
                    (criterion.score_answers(question, list_of_answers))
                amount_of_scores += 1
            return sum_of_score/amount_of_scores
